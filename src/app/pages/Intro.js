...
const Intro = () => {
  return (
    ...
    >
      <div className="flex flex-col  min-w-[370px] ml-20 xxs:m-0 sm:min-w-[390px] 2xl:min-w-[520px] z-10 gap-2 lg:gap-4 xl:gap-6 relative top-[205px] left-4  xs:top-72 sm:top-[340px] lg:left-4 lg:top-0 xl:-left-4 2xl:top-2 2xl:left-2 ">
        <Fade direction="down" duration={800} delay={500} triggerOnce={true}>
          ...
          <div className="text-3xl sm:text-4xl 2xl:text-5xl h-11 2xl:h-16 sm:h-12">
            <Typewriter
              texts={[
                "a Software Engineer.",
                "a Web Developer.",
        ...
        <Fade direction="up" duration={800} delay={500} triggerOnce={true}>
          <div className="flex gap-3 2xl:gap-5 mb-4 ">
          ...
          <a href="/files/resume.pdf" download className="2xl:w-64 ">
            <button className="group relative px-6 py-2 sm:p-2 sm:w-32 w-28 2xl:p-4 2xl:w-64 overflow-hidden rounded-md 2xl:rounded-lg bg-dark-brown 2xl:text-lg shadow text-white sm:text-base text-sm">
      ...
      <div className="w-60 xs:w-72 sm:w-[360px] lg:w-[430px] xl:w-[460px] 2xl:w-[530px] relative xxs:right-16 bottom-[230px] xs:right-8 xs:bottom-52 sm:right-16 sm:bottom-60  lg:top-0 lg:right-24 xl:right-4 2xl:right-16 2xl:-top-2">
        <div>
        ...
        <div className="drop-shadow-[8px_-2px_0px_rgba(0,0,0,0.15)] w-56 xs:w-[260px] sm:w-[300px] lg:w-[380px] 2xl:w-[465px] absolute -bottom-2 xxs:left-[162px] xs:-bottom-2 xs:left-32 sm:left-56 sm:-bottom-1 lg:left-48 2xl:top-28 2xl:left-64">
